    ...
    <div className="min-h-screen bg-app-cream">
      ...
      <div className="bg-linear-to-r from-app-orange to-app-orange-dark text-white py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/80 max-w-md mx-auto">Limited Time Offers on Selected Products.Grab them before they're gone!</p>
        </div>
      </div>
        ...
        {loading ? (<Loading />) : (
          products.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h2 className="text-lg font-semibold text-app-green mb-2">No Flash Deals Available</h2>
